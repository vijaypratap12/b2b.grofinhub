<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="AddState.aspx.cs" Inherits="Admin_ContactUsReport" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="page-title">
        <div>
            <h1><i class="fa fa-file-o"></i>Add State</h1>
    ...
    <div class="row hidden-xs">
        <div class="form-horizontal form-bordered">
            ...
            <div class="col-md-6">
                <div class="box box-orandge">
                    <div class="box-title">
                        <h3><i class="fa fa-bars"></i>Add State Details</h3>
                        <div class="box-tool">
                    ...
                    <div class="box-content">
                         ...
                         <div class="col-sm-6 col-lg-6">
                            ...
                            <label for="textfield4" class="control-label"> Country </label>
                            <div class="">

                                <%--<asp:TextBox ID="txtpropertyname" runat="server" class="form-control" ReadOnly="true"></asp:TextBox>--%>
                                <asp:DropDownList ID="ddlproperty" runat="server" class="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlproperty_SelectedIndexChanged">
                                </asp:DropDownList>
                         ...
                         <div class="col-sm-6 col-lg-6">
                            <div class="form-group">
                            <label for="textfield4" class="control-label">State Name</label>
                            <div class="">

                                <asp:TextBox ID="txtblock" runat="server" class="form-control"  MaxLength="100"></asp:TextBox>
            ...
            <div class="col-md-6">
                ...
                <div class="box box-ordange">
                    <div class="box-title">
                        <h3><i class="fa fa-bars"></i>State Details</h3>
                        <div class="box-tool">
                            <a data-action="collapse" href="#"><i class="fa fa-chevron-up"></i></a>
